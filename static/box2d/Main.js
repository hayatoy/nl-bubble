...
function reset() {
	...
	document.body.style[ 'backgroundColor' ] = '#f7f7f8';//theme[ 0 ];
...
function createBall(tx, size, col) {
    ...
    var textsize = 2 + parseInt(size * 0.1);
	text = document.createElement( 'div' );
	text.onSelectStart = null;
	text.innerHTML = '<span style="display:inline-block;color:' + theme[0] + ';font-size:' + textsize + 'px;">'+tx+'</span>';
